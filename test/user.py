...
official_data = card_data['Official']
    ...
    # 提取并打印所需信息
print(f"性别: {card_data.get('sex', '错误')}")
print(f"等级: {card_data['level_info'].get('current_level', '错误')}")
print(f"{vip_data.get('type',-9999)}")
print(f"官方认证类型: {official_data.get('type', -99999)}")
